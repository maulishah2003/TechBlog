...
<nav class="navbar navbar-expand-lg navbar-dark" style="background-color:#673ab7;">
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    <ul class="navbar-nav mr-auto">
      ...
      <li class="nav-item">
        <a class="nav-link" href="login-page.jsp"> <span class="fa fa-user-o"></span> Login </a>
      </li>
      
       <li class="nav-item">
        <a class="nav-link" href="Register_Page.jsp"> <span class="fa fa-user-circle-o"></span> Sign-up </a>
      </li>
